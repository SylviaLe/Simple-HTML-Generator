...
def main():
    ...
    with open('config1.txt', 'r') as f:
        ...
        date_str = date.strftime(('%a %b %d %I:%M:%S %Y')) #since the footnote require info about time created
    ...
    result = css_str + table_str + authors_str
    print(result)
    with open('Your Custom Site.html', 'w') as file:
        file.write(result)
